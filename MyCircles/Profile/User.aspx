                                ...
                                <div class="card border-light-color thick-border shadow-sm">
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <asp:Button runat="server" cssClass="btn btn-primary px-4 w-100" Text="Message" CommandName="Message" CommandArgument=<%#DataBinder.Eval(Container.DataItem, "User.Id")%> />
                                            </div>
                                        </div>
                                    </div>
                                </div>
