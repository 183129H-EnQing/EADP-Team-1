        ...
        <div class="container-fluid">
            ...
            <div class="row d-flex">
                <div class="col d-flex justify-content-center">
                    <div class="col-md-6 mt-3 border border-secondary panel-group" style =" border-radius:16px 16px">
                 ...
                 <div class="col-3 pl-0">
                       <div class="card" style="width: 18rem;">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">#Guitar<br><asp:Button ID="Button1" runat="server" Text="Add"  class="btn btn-primary" data-toggle="popover" data-content=" Following" style="border-radius:10px" ></asp:button></li>
                            <li class="list-group-item">#Starwars&nbsp<asp:Button ID="Button2" runat="server" Text="Add" class="btn btn-primary" style="border-radius:10px"></asp:button></li>
                            ...
                            <div class="card"  id="mypost"   runat="server">                                                                    
                                ...
                                <div class="card-body">	
			                        <div class="responsive">
                                        ...
                                        <p class="card-text">
                                            <strong><asp:Label ID="LPost" runat="server" Text="Label"></asp:Label></strong></p>
			                        </div>
                                </div>
