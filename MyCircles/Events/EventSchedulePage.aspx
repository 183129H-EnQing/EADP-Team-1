   ...
   <form runat="server">
       <div class="container">
                   ...
                   <div class="card card-body">
                       ...
                       <div class="row">
                           <div class="col-6 mt-2">
                               ...
                               <asp:TextBox type="text" class="form-control" ID="eventNameEventTBSchedule" runat="server" placeholder="Enter Your Event Name Here"></asp:TextBox>
                           </div>
                           <div class="col-6 mt-2">
           ...
           <div class="row mt-4">
               <div class="col-12">
                   <div class="card card-body">
                       <asp:GridView ID="eventScheduleDatagv" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true">
                           <Columns>
                               <asp:BoundField DataField="startTime" HeaderText="StartTime" />
                               <asp:BoundField DataField="endTime" HeaderText="EndTime" />
                               <asp:BoundField DataField="eventActivity" HeaderText="Event Name" />
